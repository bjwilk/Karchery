    ...
    <>
      <Navbar>
          ...
          <Upper>
           ...
           <h1 style={{color: '#A5D0CC', fontFamily: 'Arial, sans-serif'}}>Bio</h1>
       ...
       <Middle>
            ...
            <p style={{fontSize: '20px'}}>Whether you have always wished to learn archery, think it might be a fun experience or want to have a team building event, I offer Private Lessons and Group Events at <u>Ohlone Archery, San Leandro, CA</u>.</p>
            <ul>
              <li><span><strong>Events can accommodate up to 24 participants</strong>.</span></li>
              <li><span><strong>All participants must be 14 years of age or older</strong>.</span></li>
            </ul>
      ...
      <Footer>
        <div>
          <a href="mailto:napoli.kari@gmail.com" style={{color: 'gold'}}>email: napoli.kari@gmail.com</a>
            <a href="tel:+17075831707"><p style={{color: 'gold'}}>Phone: 707-583-1707</p></a>
        </div>
        <a href="https://eastbayarchery.simplybook.me">
                <Button>Book Event</Button>
              </a>
